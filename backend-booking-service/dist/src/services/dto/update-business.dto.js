...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Zen Spa' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'zen-spa', description: 'URL-safe slug, must be unique' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(200),
    __metadata("design:type", String)
], UpdateBusinessDto.prototype, "slug", void 0);
__decorate([
