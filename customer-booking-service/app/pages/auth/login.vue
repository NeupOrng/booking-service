  ...
  <div class="min-h-screen flex" style="background: hsl(210, 20%, 97%);">
    ...
    >
      <div class="absolute inset-0 opacity-10"
        style="background-image: radial-gradient(circle at 30% 60%, white 1px, transparent 1px); background-size: 50px 50px;">
      </div>
      <div class="relative z-10 max-w-sm text-center">
        ...
        <p class="text-white/65 text-base leading-relaxed">
          Sign in to manage your bookings, view upcoming appointments, and discover new services.
        </p>
      </div>
    </div>
        ...
        <div class="bg-card rounded-2xl border border-border p-8 listeo-shadow">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="space-y-1.5">
              ...
              <Input id="password" v-model="password" type="password" placeholder="••••••••" required autocomplete="current-password" class="h-11" />
            </div>
          ...
          <p class="text-center text-sm text-muted-foreground mt-5">
            ...
            <NuxtLink to="/auth/register" class="text-primary font-semibold hover:underline">Sign up</NuxtLink>
          </p>
        </div>
      </div>
    </div>
